const project_list = [
  ...
  },
  {
    ...
    project_description: 'This is a generator for different types of random values and also some simple tools that I\'ve built over a while. It is made with ReactJS, Material-UI, and TypeScript. I plan on adding a lot more functionality to it in the future along with a better UI and possibly advertisements.',
    experience_chips: [
      "ExpressJS",
      "HTML/CSS",
      "Material-UI",
