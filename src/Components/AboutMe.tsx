                ...
                <Grid container item xs={12} md={6} p={2}>
                    <Grid item xs={12} sx={BioBoxStyle()}>
                        ...
                        <Typography
                            ...
                            mb={2}
                        >
                            I work as a full stack developer, building everything from backend services and APIs to internal tools and dashboards. I’ve worked on IoT platforms, cloud infrastructure, and custom deployment systems, and I enjoy tackling interesting problems and writing clean, dependable code that lasts.
                        </Typography>
                        <Typography
                            variant="body1"
                            textAlign={"left"}
                        >
                            I like being part of teams that support each other and care about the work they do. I appreciate having steady, meaningful projects to focus on, where I can keep learning and contribute to something useful. Outside of work, I spend time with my wife and our two dogs, explore the Scottish countryside, play games, and work on side projects for fun.
                        </Typography>
                    </Grid>
                    {/* <Typography
            variant="body1"
